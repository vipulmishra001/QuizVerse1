...
--
-- Host: localhost    Database: quizverse
-- ------------------------------------------------------
...
INSERT INTO `questions` VALUES (4,1,'Capital of India?','Delhi','Mumbai','Chennai','Kolkata','A');
...
INSERT INTO `quizzes` VALUES (1,'General Knowledge','GK');
...
CREATE TABLE `scores` (
  ...
  CONSTRAINT `scores_ibfk_2` FOREIGN KEY (`quiz_id`) REFERENCES `quizzes` (`quiz_id`)
...
-- Dump completed on 2025-12-17 21:08:10
